...
import com.example.shippingapp.HomePage;
...
public class LocationTrack extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        HomePage.updateLocationDTO = UpdateLocationDTO.builder().userId(HomePage.user.getId()).latitude(location.getLatitude()).longitude(location.getLongitude()).build();
        Gson gson = new Gson();
        String message = gson.toJson(HomePage.updateLocationDTO);
